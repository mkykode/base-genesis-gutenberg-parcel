...
function local695_enqueue_scripts_styles() {
	...
	wp_enqueue_style( 'local695-ionicons', '//unpkg.com/ionicons@4.1.2/dist/css/ionicons.min.css', [], genesis_get_theme_version() );
	wp_enqueue_style( 'main-css', get_stylesheet_directory_uri() . '/assets/main.css', [], null );

	wp_enqueue_script( 'local695-global-script', get_stylesheet_directory_uri() . '/js/global.js', [ 'jquery' ], '1.0.0', true );
	wp_enqueue_script( 'local695-block-effects', get_stylesheet_directory_uri() . '/js/block-effects.js', [], '1.0.0', true );

	$suffix = ( defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ) ? '' : '.min';

	wp_enqueue_script( 'local695-responsive-menu', get_stylesheet_directory_uri() . '/js/responsive-menus' . $suffix . '.js', [ 'jquery' ], genesis_get_theme_version(), true );
...
function local695_custom_footer_logo() {
	...
	$footer_logo      = get_theme_mod( 'local695-footer-logo', local695_get_default_footer_logo() );
